...
local executor = Hydrogen and Fluxus() or 'Unknown'
...
Groups.HitTiming = Tabs.Main:AddLeftGroupbox('Hit timing')
    ...
    Groups.HitTiming:AddSlider('ReleaseDelay',   { Text = 'Note delay', Min = -1000, Max = 1000, Default = 20, Rounding = 0, Compact = true, Suffix = 'ms' })
    Groups.HitTiming:AddSlider('HeldDelay',      { Text = 'Held note delay', Min = -20, Max = 1000, Default = 0, Rounding = 0, Compact = true, Suffix = 'ms' })
        
    Groups.HitTiming:AddLabel('Random delay')
    Groups.HitTiming:AddSlider('NoteDelayMin',   { Text = 'Min note delay', Min = -1000, Max = 1000, Default = 0,    Rounding = 0, Compact = true, Suffix = 'ms' })
    Groups.HitTiming:AddSlider('NoteDelayMax',   { Text = 'Max note delay', Min = 0, Max = 1000, Default = 20,   Rounding = 0, Compact = true, Suffix = 'ms' })
    
    Groups.HitTiming:AddSlider('HeldDelayMin',   { Text = 'Min held note delay', Min = -1000, Max = 1000, Default = 0,   Rounding = 0, Compact = true, Suffix = 'ms' })
    Groups.HitTiming:AddSlider('HeldDelayMax',   { Text = 'Max held note delay', Min = -1000, Max = 1000, Default = 20,  Rounding = 0, Compact = true, Suffix = 'ms' })
